  ...
  const generateBillContent = (bill: Bill) => {
    ...
    if (bill.paidAmount > 0) {
      if (bill.paymentMethod === 'cash') {
        ...
        paymentMethodText = `UPI - ${bill.upiType}`;
      } else if (bill.paymentMethod === 'check') {
        paymentMethodText = `Check/DD - ${bill.bankName} - ${bill.checkNumber}`;
...
Use "Confirm Bill" to save this bill.
  ...
  // Get customer balance and history for display
      ...
      <div className="max-w-7xl mx-auto p-2 sm:p-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-3 sm:p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-3">
              ...
              <div className="flex flex-col gap-2">
                <div className="text-lg font-bold">
                  New Balance: ₹{((totalAmount + (selectedCustomer ? getCustomerBalance(selectedCustomer) : 0)) - (parseFloat(paymentAmount) || 0)).toFixed(2)}
                </div>
                <button
            ...
            <div className="border-t pt-3">
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                <button
                  onClick={printCurrentBillingForm}
        ...
        {currentView === 'balance' && userType === 'owner' && (
          <div className="bg-white rounded-lg shadow-md p-3 sm:p-4">
            ...
            {/* Current Balance - UPDATED with bigger font */}
            {balanceCustomer && (
